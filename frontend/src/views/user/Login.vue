...
import { User, Lock, Menu, Phone } from '@element-plus/icons-vue'
import { useTokenStore } from '@/stores/token.js'
import { getCaptchaService } from '@/api/capthca.js'
import { userLoginService, userRegisterService } from '@/api/user/user.js'
...
const clearFormData = () => {
  ...
  registerData.value = { username: '', password: '', rePassword: '', captchaId: '', captchaCode: '' }
}
...
const refreshCaptcha = async () => {
  try {
    ...
    registerData.value.captchaId = captchaId.value
    console.log('验证码已刷新，captchaId:', captchaId.value)
  } catch (error) {
